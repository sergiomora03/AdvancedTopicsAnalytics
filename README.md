...
| Date | Session         | Notebooks/Presentations          | Exercises |
| :----| :----| :------------- | :------------- | 
| October 7th | Graph Neural Network | <ul><li>[L27 - Graph Neural Networks](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L26-GraphNeuralNetworks.ipynb)</li><li>[L28 - Graph Convolutional Networks](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L27-GraphConvolutionalNetworks.ipynb)</li><li>[L29 - Graph Attention Networks](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L27-GraphAttentionNetworks.ipynb)</li></ul> | |
| October 14th | Graph Machine Learning Task | <ul><li>[L30 - Graph Classification](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L28-GraphClassification.ipynb)</li><li>[L31 - Link Prediction](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L29-LinkPrediction.ipynb)</li><li>[L32 - Social Network Analysis]()</li></ul> | |

...
| :----| :----| :------------- | :------------- | 
| August 17th | Introduction to DL |  <ul><li>[1 - Introduction to DP]() </li></ul> <ul><li>[2 - DL Pipeline]() </li></ul> | <ul><li>[E1 - Deep Learning]() </li> </ul> | 
| August 24th | Introduction to DL |  <ul><li>[1 - Introduction to DP]() </li></ul> <ul><li>[2 - DL Pipeline]() </li></ul> | <ul><li>[E1 - Deep Learning]() </li> </ul> | 
| August 31th | Introduction to DL |  <ul><li>[1 - Introduction to DP]() </li></ul> <ul><li>[2 - DL Pipeline]() </li></ul> | <ul><li>[E1 - Deep Learning]() </li> </ul> | 

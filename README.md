...
| October 14th | Graph Machine Learning Task | <ul><li>[L35 - Graph Classification](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L28-GraphClassification.ipynb)</li><li>[L36 - Link Prediction](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/L29-LinkPrediction.ipynb)</li><li>[L37 - Social Network Analysis]()</li></ul> | [P2 - Graph Machine Learning (V2 WIP)]() / [P2 - Graph Machine Learning (V1)](https://github.com/sergiomora03/AdvancedTopicsAnalytics/blob/main/notebooks/Proyecto_GML.pdf)|
